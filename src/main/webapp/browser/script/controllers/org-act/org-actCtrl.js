 ...
 */
(function () {
    angular.module('activities').controller('orgActCtrl', ['activitiesResource', '$scope', '$uibModal', 'actOperateService', orgActCtrl]);
    function orgActCtrl(activitiesResource, $scope, $uibModal, actOperateService) {
